 ...
 */
{
    class Details {
        ...
        constructor() {
            ...
            <br>
            <button class="details__addtocart">Tải file</button>
            <button class="details__close"><svg class="icon icon--cross"><use href="#icon-cross"></use></svg></button>
            <button class="details__magnifier"><svg class="icon icon--magnifier"><use href="#icon-magnifier"></use></svg></button>
            `;
        ...
        initEvents() {
            ...
            this.DOM.cart.addEventListener('click', () => this.getFile());
        }
        ...
        zoomIn() {
            ...
            if (win.w < 0.8 * win.h) {
                ...
                Object.assign(imgAnimeOpts, {
                    scaleX: 0.85 * win.w / parseInt(0.8 * win.h),
                    scaleY: 0.85 * win.w / parseInt(0.8 * win.h),
                    rotate: 90
                });
            }
            anime(imgAnimeOpts);
        ...
        getFile() {
            ...
            window.open("/static/" + this.filename
                , "_blank");
        }
    };
    ...
    class Item {
        constructor(el) {
            ...
            this.info = {
                ...
                filename: this.DOM.product.querySelector('.file_name').innerHTML
            };
